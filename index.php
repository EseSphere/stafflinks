...
<head>
    ...
    <meta name="description" content="WorkSphere is an all-in-one platform to manage staff, clients, schedules, and finances efficiently. Streamline operations and empower your team with a centralized web app." />
    ...
    <meta property="og:image" content="img/wsLogo.png" />
    ...
    <meta name="twitter:image" content="img/wsLogo.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <link rel="icon" href="img/wsLogo.png" type="image/png" />
    <link rel="apple-touch-icon" sizes="180x180" href="img/wsLogo.png">
    <link rel="shortcut icon" href="img/wsLogo.png" type="image/x-icon">
