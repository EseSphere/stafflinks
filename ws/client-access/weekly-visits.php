    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        async function loadWeeklyVisits(startDate) {
            try {
                ...
                const response = await fetch(`get_weekly_visits.php?startDate=${encodeURIComponent(start)}&clientId=${encodeURIComponent(clientId)}`);
                    ...
                    ['Morning', 'Extra Morning', 'Lunch', 'Extra Lunch', 'Tea', 'Extra Tea', 'Bed', 'Extra Bed'].forEach(slot => {
                        ...
                        `;
                            div.addEventListener('click', () => {
                                window.location.href = `visit-details.php?userId=${visit.visit_id}&logs=${visit.client_specId}`;
                            });
                        ...
                        if (slot.startsWith('Extra')) {
                            ...
                            table.querySelectorAll(`.extra-${extraType}`).forEach(col => col.style.display = '');
                        }
                    });
