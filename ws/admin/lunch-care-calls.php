...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        <div class="row">
            <div class="col-xl-8">
                <h5>Update care call<br><small><?php print $client_fullName; ?> Lunch visit time</small></h5>
                <hr>
                ...
                <div style="width: 100%; height:auto; padding:2px; text-align:right;">
                    ...
                    <input form="formClearVisit" id="txtClearVisitTime" name="txtClearVisitTime" value="Lunch-call" hidden>
                ...
                <br><br>
                <form method="POST" action="./processing-lunch-care-call" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
