                ...
                <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                    <div class="d-flex justify-content-end">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a type="button" href="./cancel-client-care-call?userId=<?= $userId ?>&spec=<?= $myuryyToeSS4 ?>&name=<?= $clientFullName ?>&visit=<?= $mycare_calls ?>" class="btn btn-outline-primary">Cancel</a>
                    ...
                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4">
                        <div class="card mb-4">
                            <div class="card-header bg-light">
                                ...
                                <button type="button" class="btn btn-primary btn-sm float-end" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fas fa-edit"></i></button>
