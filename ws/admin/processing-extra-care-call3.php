...
if (isset($_POST['btnSubmitExtraCall'])) {
    ...
    $txtExtraTeaCareCall = "ET tea call"; // static value
    ...
    $txtETTeaStarts    = $_POST['txtTeaStarts']    ?? '';
    $txtETTeaEnd       = $_POST['txtTeaEnd']       ?? '';
