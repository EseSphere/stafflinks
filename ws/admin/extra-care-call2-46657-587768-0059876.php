...
$carecall = 'EL lunch call';
$_SESSION['client_fullName'] = $client_fullName;
$stmt->close();

$stmt = $conn->prepare("SELECT col_special_Id, col_name 
FROM tbl_invoice_rate WHERE col_company_Id = ?");
...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        <div class="row">
            <div class="col-xl-8">
                <h5>Update extra lunch call<br><small><?php echo "" . $client_fullName . ""; ?> Extra lunch care call</small></h5>
                <hr>
                ...
                <div style="width: 100%; height:auto; text-align:right;">
                    <a href="./carers-required-extra-care-call?uryyToeSS4=<?php print $uryyToeSS4; ?>" style="text-decoration: none;" class="btn btn-outline-secondary btn-small">Carers</a>
                    <a href="./visit-details?uryyToeSS4=<?php print $uryyToeSS4; ?>" style="text-decoration: none;" class="btn btn-outline-info btn-small">Details</a>
                    <input form="formClearVisit" id="txtClearVisitTime" name="txtClearVisitTime" value="Extra-Lunch-call" hidden>
                ...
                <form method="POST" action="./processing-extra-care-call2" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
                    <input name="clientId" type="hidden" value="<?php echo "" . $row['uryyToeSS4'] . ""; ?>">
                    <input name="txtClientFullName" type="hidden" value="<?php echo "" . $client_fullName . ""; ?>">
                    <input name="txtClientCity" type="hidden" value="<?php echo "" . $row['client_city'] . ""; ?>">
                    <input name="txtClientArea" type="hidden" value="<?php echo "" . $row['client_area'] . ""; ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                    <div style="margin-top: 40px;" class="form-group">
                                        <div style="background-color:rgba(189, 195, 199,.2); font-size:16px; height:120px; font-weight:600; border-left:8px solid rgba(192, 57, 43,1.0); padding:22px; border-radius:5px;">
                                        ...
                                        <select style="height: 50px;" name="txtRequiredCarers" required class="form-control" id="exampleFormControlSelect1">
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                    <div style="margin-top: 40px;" class="form-group">
                                        <div style="background-color:rgba(189, 195, 199,.2); font-size:16px; height:120px; font-weight:600; border-left:8px solid rgba(39, 174, 96,1.0); padding:22px; border-radius:5px;">
                                            Use the select box below to choose the funding appropriate for this care call.
                                        </div>
                                        <br>
                                        <label for=" exampleInputPassword1">Funding<span style="color: red;">*</span></label>
                                        <select style="height: 50px;" name="txtClientFunding" required class="form-control" id="exampleFormControlSelect1">
                                            <option value="" selected="selected" disabled="disabled">--Select Option--</option>
                                            <?php
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<option value='" . $row['col_special_Id'] . "'>" . $row['col_name'] . "</option>";
                                            }
                                            $stmt->close();
                                            ?>
                                        </select>
                                            ...
                                            <div id="displayCustomCheckBox" style="width: 100%; height:auto; background-color:rgba(189, 195, 199,.3); padding:12px;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7 col-7">
                                                        ...
                                                        <select style="height: 50px;" name="txtPeriodCategory" value="Null" class="form-control" id="exampleFormControlSelect1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" required value="<?php print $today; ?>" name="txtLunchStarts" class="form-control" id="exampleInputStarts" aria-describedby="StartDate" placeholder="Starts">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="txtLunchEnd" value="<?php print $tomorrowDate; ?>" class="form-control" id="exampleInputStarts" aria-describedby="StartDate" placeholder="Starts">
                                            </div>
                                        </div>
                                    </div>
                                </div>
