...
// Define all normal and extra calls in the order you want them displayed
$callOrder = [
    'Morning',
    'EM morning call',
    'Lunch',
...
// Dynamically build SQL ORDER BY FIELD list
...
$sql = "SELECT 
        ...
        WHERE Clientshift_Date = ? AND uryyToeSS4 = ? AND call_status = 'Completed'
