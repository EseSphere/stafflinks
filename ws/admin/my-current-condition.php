...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btnAddNotes'])) {
    ...
    $stmt = $conn->prepare("UPDATE tbl_general_client_form SET my_current_condition = ? WHERE uryyToeSS4 = ?");
            ...
            <div class="col-md-4 col-xl-8">
                ...
                <div class="card">
                    <div class="card-body" style="font-size: 16px;">
                        <form action="./my-current-condition<?php echo "?uryyToeSS4=" . $row['uryyToeSS4'] . " "; ?>" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="Certificate name">My current condition.</label>
