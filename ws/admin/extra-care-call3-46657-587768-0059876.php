...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        <div class="row">
            <div class="col-xl-8">
                <h5>Update extra tea call <br> <small><?php echo "" . $client_fullName . ""; ?> Extra tea care call</small></h5>
                <hr>
                ...
                <div style="width: 100%; height:auto; text-align:right;">
                    ...
                    <input form="formClearVisit" id="txtClearVisitTime" name="txtClearVisitTime" value="Extra-Tea-call" hidden>
                ...
                <form method="POST" action="./processing-extra-care-call3" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" required value="<?php print $today; ?>" name="txtTeaStarts" class="form-control" id="exampleInputStarts" aria-describedby="StartDate" placeholder="Starts">
                                        ...
                                        <div class="col-md-6 col-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="txtTeaEnd" value="<?php print $tomorrowDate; ?>" class="form-control" id="exampleInputStarts" aria-describedby="StartDate" placeholder="Starts">
