    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h4 class="m-b-10">Invoicing rate</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-md-12">
                <a href="./new-invoice-rate" style="text-decoration:none;" class="btn btn-outline-secondary">New invoice rate</a>
                <br><br>
