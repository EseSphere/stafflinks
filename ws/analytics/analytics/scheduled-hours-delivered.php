    ...
    <div class="row">
        <div class="col-lg-6 d-flex align-items-strech">
            <div class="card w-100">
                ...
                <p style="font-size: 16px; margin-top:-25px; font-weight:600; padding:2px 0px 0px 22px;">Generate Statistics</p>
                <hr>
                <div class="card-body">
                ...
                <div class="col-lg-12">
                    <div class="card overflow-hidden">
                        <div class="card-body p-4">
                            <h5 class="card-title mb-9 fw-semibold">Recent Statistics</h5>
                            ...
                            <div class="row align-items-center">
                                <canvas id="barChartCareTask" width="800" height="400"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="./scheduled-hours-delivered.js"></script>
