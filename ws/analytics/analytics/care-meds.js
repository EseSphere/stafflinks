const dbName = 'CareMedsDB';
const storeName = 'CareMedsResults';
...
document.getElementById('trendForm').addEventListener('submit', async function (e) {
    ...
    try {
        const response = await fetch('processing-care-meds.php', {
            method: 'POST',
...
function renderChart(labels, counts) {
    ...
    const canvas = document.getElementById('barChartCareMeds');
    if (!canvas) {
        console.error('Canvas element with ID "barChartCareMeds" not found.');
        return;
    }
