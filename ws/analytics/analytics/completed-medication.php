    ...
    <div class="row">
        <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card w-100">
                <h4 class="p-4 mt-3"><strong>Completed Medication</strong></h4>
                        ...
                        <div class="mb-3 mb-sm-0">
                            ...
                            <form id="trendForm">
                                <div class="container mt-1">
                                    <div class="row g-3">
                                        <p style="font-size: 16px; margin-top:-25px; font-weight:600;"><i class="fa fa-list"></i> &nbsp; Complete the form</p>
                                        <div class="col-md-6">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body p-4">
                            ...
                            <div class="row align-items-center">
                                <canvas id="barChartCompMedication" width="800" height="400"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="./completed-medication.js"></script>
