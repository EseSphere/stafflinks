                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form method="POST" action="./add-new-client" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleFormControlClientailment">Medical condition!<span style="color: red;">*</span></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group">
                                                        <label for="exampleInputPassword1">Care service</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <br>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">Who am I?<span style="color: red;">*</span></label>
