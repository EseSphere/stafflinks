...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        <div class="row">
            <div class="col-xl-8">
                <h5>Update extra bed call<br><small><?php echo "" . $client_fullName . ""; ?> Extra bed care call</small></h5>
                <hr>
                ...
                <div style="width: 100%; height:auto; text-align:right;">
                    ...
                    <input form="formClearVisit" id="txtClearVisitTime" name="txtClearVisitTime" value="Extra-Bed-call" hidden>
                ...
                <form method="POST" action="./processing-extra-care-call4" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                    <div style="margin-top: 40px;" class="form-group">
                                        <div style="background-color:rgba(189, 195, 199,.2); height:120px; font-size:16px; font-weight:600; border-left:8px solid rgba(39, 174, 96,1.0); padding:22px; border-radius:5px;">
                                            Kindly use the select box below to chose the funding appropriate for this care call.
                                        </div>
                                        <br>
                                    ...
                                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                        ...
                                        <div style="width: 100%; height:auto; padding:6px; font-size:17px; font-weight:600;">
                                            <div style="width: 100%; height:auto; background-color:rgba(22, 160, 133,.3); padding:12px;">
                                                <div>If you wish this medication to popup once every month, kindly choose the start date and the end date below.</div>
                                                <span>Select choice</span> &nbsp;
