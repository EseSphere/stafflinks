        ...
        <div class="navbar-wrapper">
            <div class="navbar-content scroll-div ">
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item">
                        <a href="../client-details<?php echo "?uryyToeSS4=$uryyToeSS4" ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user"></i></span><span class="pcoded-mtext">Profile</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="../client-notes<?php echo "?uryyToeSS4=$uryyToeSS4" ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-book"></i></span><span class="pcoded-mtext">Note</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="../client-visits<?php echo "?uryyToeSS4=$uryyToeSS4" ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-eye"></i></span><span class="pcoded-mtext">Visits</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="../schedulled-visits<?php echo "?uryyToeSS4=$uryyToeSS4" ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-bell"></i></span><span class="pcoded-mtext">Scheduled</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="../completed-visits<?php echo "?uryyToeSS4=$uryyToeSS4" ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-thumbs-up"></i></span><span class="pcoded-mtext">Completed</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="../care-plan<?php echo "?uryyToeSS4=$uryyToeSS4" ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-heart"></i></span><span class="pcoded-mtext">Care plan</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="../settings<?php echo "?uryyToeSS4=$uryyToeSS4" ?>" class="nav-link "><span class="pcoded-micon"><i class="fas fa-qrcode"></i></span><span class="pcoded-mtext">Settings</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="../client-task<?php echo "?uryyToeSS4=$uryyToeSS4" ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user"></i></span><span class="pcoded-mtext">Task plan</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="../client-medication<?php echo "?uryyToeSS4=$uryyToeSS4" ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-activity"></i></span><span class="pcoded-mtext">Medication</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="../share-family-access<?php echo "?uryyToeSS4=$uryyToeSS4" ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-briefcase"></i></span><span class="pcoded-mtext">Share access</span></a>
                    </li>
                    <li class="nav-item">
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <a class="dropdown-toggle h-drop" href="../manage-runs">
                            <i class="feather icon-map"></i> Runs
                        </a>
                        &nbsp;&nbsp;
                        ...
                        &nbsp;&nbsp;
                        <a class="dropdown-toggle h-drop" href="../active-team">
                ...
                <li>
                    <div class="dropdown drp-user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <?php echo "" . $user['company_name'] . ""; ?> | <i class="feather icon-user"></i>
                        </a>
