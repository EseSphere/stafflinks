...
if (isset($_POST['btnSubmitCaregCall'])) {
    ...
    $txtLunchStarts = mysqli_real_escape_string($conn, $_REQUEST['txtLunchStarts'] ?? '');
    $txtLunchEnd = mysqli_real_escape_string($conn, $_REQUEST['txtLunchEnd'] ?? '');
    ...
    if ($clickDisplayDaily) {
        ...
        if ($txtDateTimeOut <= $txtDateTimeIn) {
            ...
            if ($sqlInsertCareCalls) {
                ...
                if ($sqlUpdateManageRunCareCalls) {
                    $sqlUpdateScheduleRunCareCalls = mysqli_query($conn, "UPDATE `tbl_schedule_calls` SET `dateTime_in` = '$txtDateTimeIn', `dateTime_out` = '$txtDateTimeOut', `col_required_carers` = '$txtRequiredCarers', `col_period_two` = 'Daily' WHERE (uryyToeSS4 = '$clientId' AND Clientshift_Date >= '$txtLunchStarts' AND care_calls = 'Lunch') ");
        ...
        if ($txtDateTimeOut <= $txtDateTimeIn) {
            ...
            $sqlInsertCareCalls = mysqli_query($conn, "UPDATE `tbl_clienttime_calls` SET `dateTime_in` = '$txtDateTimeIn', `dateTime_out` = '$txtDateTimeOut', `col_monday` = '$txtMonday', `col_tuesday` = '$txtTuesday', `col_wednesday` = '$txtWednesday', `col_thursday` = '$txtThursday', `col_friday` = '$txtFriday', `col_saturday` = '$txtSaturday', `col_sunday` = '$txtSunday', `col_client_funding` = '$var_client_funding_name', `col_funding_rate` = '$var_client_funding_rate', `col_required_carers` = '$txtRequiredCarers', `col_startDate` = '$txtLunchStarts', `col_endDate` = '$txtLunchEnd', `col_occurence` = '$txtLunchStarts', `col_period_two` = 'Monthly' WHERE uryyToeSS4 = '$clientId' AND care_calls = 'Lunch' AND col_company_Id = '" . $_SESSION['usr_compId'] . "' ");
            if ($sqlInsertCareCalls) {
                $sqlUpdateManageRunCareCalls = mysqli_query($conn, "UPDATE `tbl_manage_runs` SET `dateTime_in` = '$txtDateTimeIn', `dateTime_out` = '$txtDateTimeOut', `col_monday` = '$txtMonday', `col_tuesday` = '$txtTuesday', `col_wednesday` = '$txtWednesday', `col_thursday` = '$txtThursday', `col_friday` = '$txtFriday', `col_saturday` = '$txtSaturday', `col_sunday` = '$txtSunday', `col_client_funding` = '$var_client_funding_name', `col_funding_rate` = '$var_client_funding_rate', `col_required_carers` = '$txtRequiredCarers', `col_startDate` = '$txtLunchStarts', `col_endDate` = '$txtLunchEnd', `col_occurence` = '$txtLunchStarts', `col_period_two` = 'Monthly' WHERE uryyToeSS4 = '$clientId' AND care_calls = 'Lunch' AND col_company_Id = '" . $_SESSION['usr_compId'] . "' ");
                if ($sqlUpdateManageRunCareCalls) {
                    $sqlUpdateScheduleRunCareCalls = mysqli_query($conn, "UPDATE `tbl_schedule_calls` SET `dateTime_in` = '$txtDateTimeIn', `dateTime_out` = '$txtDateTimeOut', `col_required_carers` = '$txtRequiredCarers', `col_period_two` = 'Monthly' WHERE (uryyToeSS4 = '$clientId' AND Clientshift_Date >= '$txtLunchStarts' AND care_calls = 'Lunch') ");
                    if ($sqlUpdateScheduleRunCareCalls) {
                        header("Location: ./client-details?uryyToeSS4=$clientId");
                    } else {
                        header("Location: ./client-details?uryyToeSS4=$clientId");
        ...
        if ($txtDateTimeOut <= $txtDateTimeIn) {
            ...
            $sqlInsertCareCalls = mysqli_query($conn, "UPDATE `tbl_clienttime_calls` SET `dateTime_in` = '$txtDateTimeIn', `dateTime_out` = '$txtDateTimeOut', `col_monday` = '$txtMonday', `col_tuesday` = '$txtTuesday', `col_wednesday` = '$txtWednesday', `col_thursday` = '$txtThursday', `col_friday` = '$txtFriday', `col_saturday` = '$txtSaturday', `col_sunday` = '$txtSunday', `col_client_funding` = '$var_client_funding_name', `col_funding_rate` = '$var_client_funding_rate', `col_required_carers` = '$txtRequiredCarers', `col_startDate` = '$txtLunchStarts', `col_endDate` = '$txtLunchEnd', `col_occurence` = '$txtLunchStarts', `col_period_one` = '$txtPeriod', `col_period_two` = '$txtPeriodCategory' WHERE uryyToeSS4 = '$clientId' AND care_calls = 'Lunch' AND col_company_Id = '" . $_SESSION['usr_compId'] . "' ");
            if ($sqlInsertCareCalls) {
                $sqlUpdateManageRunCareCalls = mysqli_query($conn, "UPDATE `tbl_manage_runs` SET `dateTime_in` = '$txtDateTimeIn', `dateTime_out` = '$txtDateTimeOut', `col_monday` = '$txtMonday', `col_tuesday` = '$txtTuesday', `col_wednesday` = '$txtWednesday', `col_thursday` = '$txtThursday', `col_friday` = '$txtFriday', `col_saturday` = '$txtSaturday', `col_sunday` = '$txtSunday', `col_client_funding` = '$var_client_funding_name', `col_funding_rate` = '$var_client_funding_rate', `col_required_carers` = '$txtRequiredCarers', `col_startDate` = '$txtLunchStarts', `col_endDate` = '$txtLunchEnd', `col_occurence` = '$txtLunchStarts', `col_period_one` = '$txtPeriod', `col_period_two` = '$txtPeriodCategory' WHERE uryyToeSS4 = '$clientId' AND care_calls = 'Lunch' AND col_company_Id = '" . $_SESSION['usr_compId'] . "' ");
                if ($sqlUpdateManageRunCareCalls) {
                    $sqlUpdateScheduleRunCareCalls = mysqli_query($conn, "UPDATE `tbl_schedule_calls` SET `dateTime_in` = '$txtDateTimeIn', `dateTime_out` = '$txtDateTimeOut', `col_required_carers` = '$txtRequiredCarers', `col_period_one` = '$txtPeriod', `col_period_two` = '$txtPeriodCategory' WHERE (uryyToeSS4 = '$clientId' AND Clientshift_Date >= '$txtLunchStarts' AND care_calls = 'Lunch') ");
                    if ($sqlUpdateScheduleRunCareCalls) {
                        header("Location: ./client-details?uryyToeSS4=$clientId");
                    } else {
                        header("Location: ./client-details?uryyToeSS4=$clientId");
