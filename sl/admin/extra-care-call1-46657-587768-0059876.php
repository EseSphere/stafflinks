...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        <div class="row">
            <div class="col-xl-8">
                <h5>Update extra morning call <br><small><?= $client_fullName ?> Extra morning care call</small></h5>
                <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="txtMorningEnd" class="form-control" id="exampleInputStarts" aria-describedby="StartDate" placeholder="Starts">
                                                <div class="invalid-tooltip"></div>
                                            </div>
                                        </div>
                                    </div>
