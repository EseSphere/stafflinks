...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="Geosoft care - Software for care settings is a dynamic nursing, 
    domiciliary, support and agency App based in the UK. It is built on solid partnership and experience 
    spanning almost two decades within its management team." />
        ...
        <div class="navbar-wrapper">
            <div class="navbar-content scroll-div ">
                    ...
                    <div class="collapse" id="nav-user-link">
                        <ul class="list-unstyled">
                            ...
                            <li class="list-group-item"><a
                                    href="./share-access-code?col_company_Id=<?php echo "" . $_SESSION['usr_compId'] . ""; ?>"
                                    style="text-decoration: none; color:#fff;"><i
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item">
                        <a href="./team-details<?php echo "?uryyTteamoeSS4=" . $uryyTteamoeSS4 . "" ?>"
                            class="nav-link"><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span
                                class="pcoded-mtext">About me</span></a>
                    </li>

                    <li class="nav-item">
                        <a href="./team-note<?php echo "?uryyTteamoeSS4=" . $uryyTteamoeSS4 . "" ?>"
                            class="nav-link"><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span
                                class="pcoded-mtext">Notes</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="./team-visits<?php echo "?uryyTteamoeSS4=" . $uryyTteamoeSS4 . "" ?>"
                            class="nav-link"><span class="pcoded-micon"><i class="feather icon-eye"></i></span><span
                                class="pcoded-mtext">Visits</span></a>
                    </li>

                    <li class="nav-item">
                        <a href="./carer-operations<?php echo "?uryyTteamoeSS4=" . $uryyTteamoeSS4 . "" ?>"
                            class="nav-link"><span class="pcoded-micon"><i class="feather icon-heart"></i></span><span
                                class="pcoded-mtext">Operations</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="./carer-onboarding<?php echo "?uryyTteamoeSS4=" . $uryyTteamoeSS4 . "" ?>"
                            class="nav-link"><span class="pcoded-micon"><i class="feather icon-eye"></i></span><span
                                class="pcoded-mtext">Onboarding</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="./carer-skills-certs<?php echo "?uryyTteamoeSS4=" . $uryyTteamoeSS4 . "" ?>"
                            class="nav-link"><span class="pcoded-micon"><i class="feather icon-user"></i></span><span
                                class="pcoded-mtext">Skills</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="./carer-availability<?php echo "?uryyTteamoeSS4=" . $uryyTteamoeSS4 . "" ?>"
                            class="nav-link"><span class="pcoded-micon"><i
                                    class="feather icon-activity"></i></span><span
                                class="pcoded-mtext">Availability</span></a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card text-center">
                    <div class="card-block">
                        ...
                        <a href="Help center" target="_blank" class="btn btn-primary btn-sm text-white m-0">Help
                            center</a>
                    </div>
                </div>
            </div>
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu profile-notification ">
                            <ul class="pro-body">
                                <li><a href="./auth-user-profile" class="dropdown-item"><i class="fas fa-circle"></i>
                                        Profile</a></li>
                                <li><a href="./auth-messages" class="dropdown-item"><i class="fas fa-circle"></i> My
                                        Messages</a></li>
                                <li><a href="./index" class="dropdown-item"><i class="fas fa-circle"></i> Lock
                                        Screen</a></li>
                            </ul>
                        </div>
                    </div>
