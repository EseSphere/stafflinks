            ...
            <div class="navbar-wrapper">
                <div class="navbar-content scroll-div ">
                    <div class="">
                        <div class="main-menu-header">
                            <div class="user-details">
                                ...
                                <div id="more-details">Finance panel</div>
                            </div>
                        </div>
                    </div>
                    <ul class="nav pcoded-inner-navbar ">
                        ...
                        <li class="nav-item">
                            <a href="https://admin.stafflinks.co.uk/dashboard" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard</span></a>
                        </li>
                        <li class="nav-item">
        ...
        <header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            <a class="dropdown-toggle h-drop" href="https://admin.stafflinks.co.uk/rota/">
                                <i class="feather icon-layout"></i> Rota
                            </a>
                            &nbsp;&nbsp;
                            <a class="dropdown-toggle h-drop" href="https://admin.stafflinks.co.uk/manage-runs">
                                <i class="feather icon-map"></i> Manage run
                            </a>
                            &nbsp;&nbsp;
                            <a class="dropdown-toggle h-drop" href="https://admin.stafflinks.co.uk/active-clients">
                                <i class="feather icon-user"></i> Client
                            </a>
                            &nbsp;&nbsp;
                            <a class="dropdown-toggle h-drop" href="https://admin.stafflinks.co.uk/team-list">
