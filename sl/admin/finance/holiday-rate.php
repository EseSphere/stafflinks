                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h4 class="m-b-10">Holidays</h4>
                            <span>Configure your holiday rates here. For a given holiday, the multiplier will be applied to all rates on that day.</span>
                        </div>
                    </div>
                </div>
            </div>
