...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        <div class="row">
            <div class=" col-xl-8">
                <h5>Update care call <br> <small><?php print $client_fullName; ?> Morning visit time</small></h5>
                <hr>
                ...
                <div style="width: 100%; height:auto; padding:2px; text-align:right;">
                    ...
                    <input form="formClearVisit" id="txtClearVisitTime" name="txtClearVisitTime" value="Morning-call" hidden>
                ...
                <form method="POST" action="./processing-morning-care-call" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                    <div style="margin-top: 10px;" class="form-group">
                                        <div style="background-color:rgba(189, 195, 199,.2); height:120px; font-size:16px; font-weight:600; border-left:8px solid rgba(39, 174, 96,1.0); padding:22px; border-radius:5px;">
                                            Use the select box below to choose the funding appropriate for this call.
                                        </div>
                                        <br>
