    ...
    <div class="row">
        <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card w-100">
                <h4 class="p-4 mt-3"><strong>Visit Fullfiled</strong></h4>
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body p-4">
                            ...
                            <div class="row align-items-center">
                                <canvas id="barChartVisitFullfiled" width="800" height="400"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="./visit-fulfilled.js"></script>
