const dbName = 'ScheduledHoursDelDB';
const storeName = 'ScheduledHoursDelResults';
...
document.getElementById('trendForm').addEventListener('submit', async function (e) {
    ...
    try {
        const response = await fetch('processing-scheduled-hour.php', {
            method: 'POST',
...
function renderChart(labels, counts) {
    ...
    const canvas = document.getElementById('barChartSHV');
    if (!canvas) {
        console.error('Canvas element with ID "barChartSHV" not found.');
        return;
    }
